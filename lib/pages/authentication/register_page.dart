                ...
                children: [
                  Container(
                    ...
                    child: TextField(
                        ...
                        style: mulishFont(
                            15, Color.fromARGB(127, 0, 0, 0), FontWeight.w400),
                        decoration: InputDecoration(
                          border: InputBorder.none,
                          labelText: "Username",
                          labelStyle: mulishFont(15,
                              Color.fromARGB(126, 0, 0, 0), FontWeight.w400),
                  ...
                  BlocBuilder<FormValidationBloc, FormValidationState>(
                    builder: (context, state) {
                      if (state.username != '' &&
                          state is FormValidationRegister) {
                        return Text(
                          state.username,
                          style: mulishFont(
                    ...
                    child: ElevatedButton(
                      onPressed: () async {
                        context.read<FormValidationBloc>().add(
                            OnFormValidationRegister(
                                edtUsername.text, edtPassword.text));

                        if (edtUsername.text != '' && edtPassword.text != '') {
                          // add user to state
                          Users newUsers =
                              Users(edtUsername.text, edtPassword.text);
                          context.read<UsersBloc>().add(OnAddUsers(newUsers));

                          //information succes snackbar
                          DInfo.snackBarSuccess(
                              context, 'User Berhasil Di Daftarkan');
                  ...
                  Row(
                    ...
                    children: [
                      Text(
                        ...
                        style:
                            mulishFont(13, Color(0xff252525), FontWeight.w500),
                      ),
                      GestureDetector(
                        onTap: () {
                          Navigator.push(
